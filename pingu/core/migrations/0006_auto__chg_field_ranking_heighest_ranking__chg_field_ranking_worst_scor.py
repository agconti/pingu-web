...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ranking.heighest_ranking'
        db.alter_column(u'core_ranking', 'heighest_ranking', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ranking.worst_score_differential'
        db.alter_column(u'core_ranking', 'worst_score_differential', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Ranking.elo_rating'
        db.alter_column(u'core_ranking', 'elo_rating', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Ranking.heighest_ranking'
        db.alter_column(u'core_ranking', 'heighest_ranking', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Ranking.worst_score_differential'
        db.alter_column(u'core_ranking', 'worst_score_differential', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Ranking.elo_rating'
        db.alter_column(u'core_ranking', 'elo_rating', self.gf('django.db.models.fields.IntegerField')())
